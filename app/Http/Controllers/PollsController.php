...
class PollsController extends Controller
{
   public function insert_answer(){
        ...
        $newAnswer =PollAnswer::with('question')->find($id_answer);

        //if someone tries to change value in inspect element, stop it because you can vote only for active question
        if ($newAnswer->question->active == 1){
            ...
            //aborting if user manipulates answer id
            abort(403);
        }
